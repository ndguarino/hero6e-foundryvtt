...
- Fix uploading sheet images in ActorSheetV2 and resolve validation error due to duplicated inputs. [#3962](https://github.com/dmdorman/hero6e-foundryvtt/issues/3962)
